...
int samp=0, j;
long unsigned int pause_samps=8820;
...
/* Increment stimulus counts */
++stimRses[stim_number].count;
++stimRtot[stim_number].count;
++classRses[stim_class].count;
++classRtot[stim_class].count;
