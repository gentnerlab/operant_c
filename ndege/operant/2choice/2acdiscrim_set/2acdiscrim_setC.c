...
int main(int argc, char *argv[])
{
	...
	int last_10_OT[10],last_10_T[10],last_10_UT5[10],last_10_UT6[10];
	...
	do{ /* start the main loop */
		while ((currtime>=starttime) && (currtime<stoptime)){ /* start trials loop */
			...
			do{ /* start loop for one set */
					...
					if (correction == 1){
						if ((stim_class == 1) || (stim_class == 2)) {
							...
							last_10_T[curr_cycle_position_T] = resp_acc; /* keep track for history */
						                ...
						                last_10_UT5[curr_cycle_position_UT5] = resp_acc; /* keep track for history */
						                }
						                else if (stim_class == 6){
						                                last_10_UT6[curr_cycle_position_UT6] = resp_acc; /* keep track for history */
						                                }
					                                }
				...
				if (curr_cycle_position_UT5 == 10) {curr_cycle_position_UT5 = 0;}
				if (curr_cycle_position_UT6 == 10) {curr_cycle_position_UT6 = 0;}
