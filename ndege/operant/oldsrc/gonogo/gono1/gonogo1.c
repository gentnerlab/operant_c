/*****************************************************************************
** gonogo1.c - temp code for running go/nogo operant training procedure
******************************************************************************
**
	...
	for (i = 1; i < ac; i++)
	  {
		...
		if (strncmp(av[i], "-B", 2) == 0)
		  ...
		  fprintf(stderr, "        -on X           = start exp at hour X (use 24 clock)\n");
		  fprintf(stderr, "        -off X           = stop exp at hour X (use 24 hour clock)\n");
