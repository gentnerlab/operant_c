 ...
 **************************************************************************************/
int play_and_peck_stop(char *sfname, double period, int stimdur, int stimoffset, int box_id ,struct PECK * trl, struct PECKTIME * ptimes, int *numpecks, struct timeval *stimonset, int *respduringstim)
{
