...
int play_and_peck_wn2ac(char *sfname, double period, int stimdur, int stimoffset, long unsigned int wndur, long unsigned int wnoffset, float desired_db, int box_id, int stimclass, struct PECK * trl, struct PECKTIME * ptimes, int *numpecks)
{
  float ramp_time = 0.05;  /*onset offset ramp duration in secs */
  SNDFILE *sf;
  SF_INFO *sfinfo;
