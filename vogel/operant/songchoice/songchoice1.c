...
#define MAXBP                    256           /* maximum number of breakpoints per stimulus */ 
...
#define CUE_STIM_INTERVAL        0             /* pause length between cue and stim in seconds */
...
snd_pcm_t *handle;
/* const char pcm_name[] = "doubledac";      */              /* name of pcm - note: specific to box _ */
