...
int main(int argc, char *argv[])
{
  ...
  int nclasses, nstims, stim_class, stim_type, nonmatch_type, stim_reinf, stim_punish, resp_sel, resp_acc, subjectid, period, tot_trial_num, ntargtrials = 1,numtrials,
    played, resp_wind=0,trial_num, session_num, i,j,k, correction, targval,distval, dist_type, loop, stim_number, dist_number, nonmatch_number, cue[3],nrepeats, 
    *playlist=NULL, totnstims=0, mirror=0, dosunrise=0,dosunset=0,starttime,stoptime,currtime, new_trialtarg = 0, nonmatchval, sv, sampcount, start,
  ...
  double nidealsamps, nbreaksamps, fs = 44100, padded, trialsamps, noutsamps;
